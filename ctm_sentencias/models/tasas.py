...
class Tasas(models.Model):
    ...
    dtf = fields.Float('DTF',  digits=(10, 3), required=True, help="Por favor poner las tasas efectivas anuales")
    usura = fields.Float('Usura',  digits=(10, 3), required=True, help="Por favor poner las tasas efectivas anuales")
